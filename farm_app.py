...
with tabs[5]:
    ...
    if st.session_state.get('generate_report', False):
        ...
        with col3:
           # Previous code that leads to the tab6 context
with tab6:  # Or whatever your with statement is
    # ... your existing tab6 content ...
    
    # Make sure this is properly indented inside the with block:
    
    # PDF Export with professional formatting
    if not export_df.empty:  # This needs proper indentation
    ...
    # Make sure this is outside the if block but still inside the with block
    else:
        st.info("📭 No data available for PDF export. Generate a report first.")
    
    # Other content that should be inside the with block but outside the if block
    # ... rest of your tab6 content ...

# The with block continues here
