    ...
    if uploaded_file:
        try:
            ...
            if validation_errors:
                st.error("Upload Failed! Your file has errors. Please correct them and re-upload.")
                ...
                # --- Step 4: Download PDF ---
                st.subheader("Step 3: Download PDF Report")
                st.markdown("Click the button below to generate a complete PDF report for all employees.")
