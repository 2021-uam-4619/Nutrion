...
def init_database():
    conn = sqlite3.connect('Nutrion.db', check_same_thread=False)
    c = conn.cursor()
    ...
    c.execute('''
        ...
        VALUES ('default', 'Nutrion', 'Karachi, Pakistan', '+92-3207429422', 'info@hmdsolutions.com', 'PKR')
    ''')
...
def get_db_connection():
    return sqlite3.connect('Nutrion.db', check_same_thread=False)
...
def render_footer():
    ...
    <div class="footer">
        ...
        <p style="margin-top: 1rem; font-size: 0.9rem; opacity: 0.8;">
            &copy; 2024 Nutrion. All rights reserved.
        </p>
    </div>
    """, unsafe_allow_html=True)

def main():
    st.markdown('<div class="main-header"> Nutrion - Business Management System</div>', unsafe_allow_html=True)
